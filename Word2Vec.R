...
# Read text file.
doc <- readChar('C:/Users/BISYN/Desktop/R Script/word2vec/article.txt', file.info('C:/Users/BISYN/Desktop/R Script/word2vec/article.txt')$size)
...
cat(doc, file="C:/Users/BISYN/Desktop/R Script/word2vec/article2.txt",sep="\n",append=TRUE)

# Train word2vec model and explore.
model <- word2vec('C:/Users/BISYN/Desktop/R Script/word2vec/article2.txt')
# test : president - trump are very closing words in this txt file
model %>% closest_to("president")

# Cleanup.
unlink('C:/Users/BISYN/Desktop/R Script/word2vec/article2.txt')
...
# Train word2vec model and explore.
model <- word2vec('text8') # this function have long time for running
